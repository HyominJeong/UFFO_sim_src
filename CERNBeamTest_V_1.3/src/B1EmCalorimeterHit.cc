...
G4ThreadLocal G4Allocator<B1EmCalorimeterHit>* B1EmCalorimeterHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

B1EmCalorimeterHit::B1EmCalorimeterHit()
: G4VHit(), fCellID(-1), fEdep(0.), fPos(0), fPLogV(0), fGTime(0)
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

B1EmCalorimeterHit::B1EmCalorimeterHit(G4int z)
:  G4VHit(), fCellID(z), fEdep(0.), fPos(0), fPLogV(0), fGTime(0)
{}
...
B1EmCalorimeterHit::B1EmCalorimeterHit(const B1EmCalorimeterHit &right)
: G4VHit() {
...
const B1EmCalorimeterHit& B1EmCalorimeterHit::operator=(const B1EmCalorimeterHit
                                                          &right)
{
    fCellID = right.fCellID;
    fEdep = right.fEdep;
...
int B1EmCalorimeterHit::operator==(const B1EmCalorimeterHit &right) const
{
...
const std::map<G4String,G4AttDef>* B1EmCalorimeterHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("B1EmCalorimeterHit",isNew);
...
std::vector<G4AttValue>* B1EmCalorimeterHit::CreateAttValues() const
{
    ...
    values
      ->push_back(G4AttValue("Time",G4BestUnit(fGTime,"Time"),""));
...
void B1EmCalorimeterHit::Print()
{
    G4cout << "  Cell[" << fCellID << "] " << fEdep/keV << " (keV)" << G4endl;
}
