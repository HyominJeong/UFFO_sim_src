...
#ifndef B1EmCalorimeterHit_h
#define B1EmCalorimeterHit_h 1
...
public:
    ...
    void SetGTime(G4double t) { fGTime = t; }
    G4double GetGTime() const { return fGTime; }
...
typedef G4THitsCollection<B1EmCalorimeterHit> B1EmCalorimeterHitsCollection;
