...
#ifndef B1CellParameterisation_H
#define B1CellParameterisation_H 1
...
class B1CellParameterisation : public G4VPVParameterisation
{
public:
    B1CellParameterisation();
    virtual ~B1CellParameterisation();
