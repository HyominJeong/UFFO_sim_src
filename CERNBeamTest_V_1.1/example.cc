...
int main(int argc, char** argv)
{
  ...
  // Create runManager, PhysicsList, and add classes

  G4VisManager* visManager = new G4VisExecutive;
  visManager -> Initialize();
  // set G4VisManager for display
  ...
  return 0;
  // set G4UImanager and macro for simulation command lines
}
